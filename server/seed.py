...
with app.app_context():
    ...
    db.session.add_all([Arcana(id=arcana["id"], name=arcana["name"]) for arcana in arcanas])
    ...
    db.session.add_all([
        Wildcard(
            ...
            initial_persona_id=wildcard["initial_persona_id"]
        )
