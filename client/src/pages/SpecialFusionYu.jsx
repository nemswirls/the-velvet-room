...
const FusionMiddle = styled(FusionSection)`
  background-image: url('/images/personas/persona201.png');
  background-size: contain;
  background-position: center;
  background-repeat: no-repeat;
`;
...
const FusionRight = styled(FusionSection)`
  background-image: url('/images/personas/persona202.png');
  background-size: contain;
  background-position: center;
  background-repeat: no-repeat;
`;
...
const SpecialFusionContainer = styled.div`
  background-color: #faa622;  /* Change this to your desired background color */
  padding: 20px;

`;
const SpecialFusionYu = () => {
